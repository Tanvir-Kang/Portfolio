...
export const profileDescription: TextCardProps = {
    ...
    bodyText: "Hello! I am a junior level software engineer in search of a new engineering role. I am a personable developer who loves to take on a challenge. My personal goals are continuous improvement and consistent learning to keep my skill set evolving. I love problems that require grit and perseverance to solve.",
}
